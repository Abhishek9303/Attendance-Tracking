...
export const EmployeeAttendanceDetailsScreen = ({ route, navigation }: any) => {
  ...
  const fetchDetails = async (showLoader = true) => {
    ...
    try {
      const res = await apiClient.get(`/api/admin/attendance/${employeeId}`, {
  ...
  // SVGs for Premium Analytics Section
  const renderPremiumAnalytics = () => {
    ...
    // Premium Progress Ring parameters
    const size = 100;
    const strokeWidth = 8;
    ...
    return (
      <View style={[GLASS_STYLES.card, styles.analyticsCard]}>
        <Text style={styles.analyticsTitle}>Punctuality & Trends</Text>
        ...
        <View style={styles.analyticsRow}>
          ...
          <View style={styles.chartContainer}>
            ...
            <View style={styles.chartTextWrapper}>
              ...
              <Text style={styles.chartSubLabel}>On-Time</Text>
            </View>
          </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Individual Logs</Text>
      </View>
          ...
          <View style={styles.modalOverlay}>
            ...
            <View style={styles.bottomSheet}>
              ...
              <ScrollView contentContainerStyle={styles.sheetContent}>
                ...
                {selectedDayDetail.selfieUrl && selectedDayDetail.selfieUrl !== 'LEAVE' && (
                  <View style={styles.selfieContainer}>
                    <Text style={styles.sheetLabel}>Verification Selfie</Text>
                    <View style={styles.selfiePlaceholder}>
                      <Text style={{ color: COLORS.textSecondary, fontSize: 12 }}>
                        Selfie Verified (Secure Base64 Upload)
                      </Text>
                    </View>
                  </View>
                )}
